...
### Can I run DClaw Doc without Kubernetes?

Yes, for local development:

```bash
cd dclaw-doc/frontend && npm run dev
cd dclaw-doc/backend && uvicorn dclaw_doc.main:app --reload
```
