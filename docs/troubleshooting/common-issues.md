...
# Check events
kubectl get events -n dclaw-doc --sort-by='.lastTimestamp'

# Verify database connection
kubectl exec -n dclaw-doc deployment/dclaw-doc-backend --   python -c "import asyncio; from sqlalchemy import text; ..."
```
...
2. Check the connection string secret:
   ```bash
   kubectl get secret dclaw-doc-db-credentials -n dclaw-doc
   ```
